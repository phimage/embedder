...
std::vector<int> Embedder::tokenize(const std::string& text) {
    // Simple whitespace tokenization TODO: use a proper BERT tokenizer
    ...
    while (iss >> word) {
        ...
        if (it != vocab_.end()) {
            ...
            // Unknown token - you might want to handle subword tokenization here
